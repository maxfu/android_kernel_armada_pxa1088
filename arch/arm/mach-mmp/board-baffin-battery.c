...
static sec_charging_current_t charging_current_table[] = {
	...
	{1050,  1050,   100,    1800},     /* POWER_SUPPLY_TYPE_MAINS */
	...
	{1050,  1050,   100,    1800},     /* POWER_SUPPLY_TYPE_UARTOFF */
};
...
//	SEC_BATTERY_CABLE_SOURCE_EXTENDED,
	...
	.full_condition_type = SEC_BATTERY_FULL_CONDITION_SOC | SEC_BATTERY_FULL_CONDITION_NOTIMEFULL,
...
void __init pxa986_baffin_battery_init(void)
{
	pr_info("%s: baffin charger init\n", __func__);
