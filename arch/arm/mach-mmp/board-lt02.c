...
static struct regulator_init_data pm800_regulator_data[] = {
	...
	[PM800_ID_LDO8]  = REG_INIT(LDO8,  1800000, 1800000, 0, 1),
	...
	[PM800_ID_LDO14] = REG_INIT(LDO14, 2800000, 2800000, 0, 1),
	[PM800_ID_LDO15] = REG_INIT(LDO15, 1200000, 3300000, 0, 0),
	[PM800_ID_LDO16] = REG_INIT(LDO16, 1200000, 3300000, 0, 1),
	[PM800_ID_LDO17] = REG_INIT(LDO17, 1200000, 3300000, 0, 1),
	[PM800_ID_LDO18] = REG_INIT(LDO18, 1700000, 3300000, 1, 1),
	[PM800_ID_LDO19] = REG_INIT(LDO19, 1700000, 3300000, 0, 1),
...
#if defined(CONFIG_SENSORS_BMC150) || defined(CONFIG_SENSORS_GP2A0X0)
...
static struct atsn10p_platform_data atsn10p_pdata = {
	.t_out = mfp_to_gpio(GPIO_RF_TOUCH_INT),
	.adj_det = NULL,// GPIO_ADJ_DET,
};
...
static int grip_gpio_init(void)
{
	...
	i2c_devs10.irq = gpio_to_irq(GPIO_RF_TOUCH_INT); /* interrupt */

	/* test jig detect pin initialization */
//	ret = gpio_request(GPIO_ADJ_DET, "atsn01p_adj_det");
//	gpio_set_value(GPIO_ADJ_DET, 0);
...
static void grip_init_code_set(void)
{
	...
	atsn10p_pdata.init_code[SET_PROX_PER] = 0x30;
	atsn10p_pdata.init_code[SET_PAR_PER] = 0x30;
	...
	atsn10p_pdata.init_code[SET_TOUCH_MFM_CYC] = 0x34;
...
static struct bt532_ts_platform_data bt532_ts_pdata = {
	...
	.gpio_scl		= TSP_SCL_LT02_R0_0,
	.gpio_sda		= TSP_SDA_LT02_R0_0,
	.x_resolution	= 599,
	.y_resolution	= 1024,
	.page_size		= 128,
	.orientation	= 6,
...
static struct platform_pwm_backlight_data harrison_lcd_backlight_data = {
       /* primary backlight */
	 .name = "emei-bl",
       .pwm_id = 4,
       .max_brightness = 100,
...
static struct platform_device harrison_lcd_backlight_devices = {
       .name = "pwm-backlight",
       .id = 0,
       .dev = {
               .platform_data = &harrison_lcd_backlight_data,
       },
 };
...
MMP_HW_DESC(fb, "pxa168-fb", 0, PM_QOS_CPUIDLE_BLOCK_DDR_VALUE, "mmp_disp");
