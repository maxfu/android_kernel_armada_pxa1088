				...
				struct pm80x_platform_data *pdata)
{
	...
	*/
	...
	/* WIFI set current limit as 600mA instead of 450mA*/
	regmap_write(chip->subchip->regmap_power, PM800_LDO_MISC6, 0x56);
...
static struct pm80x_platform_data pm800_info = {
	...
	.irq_mode = 1,	/* 0: clear IRQ by read */
...
static void board_sensors_init()
{
	...
	#if defined(CONFIG_SENSORS_GP2A002S)
		i2c_register_board_info(5, ARRAY_AND_SIZE(i2c_gp2a));
	#endif
}
#endif
...
static struct pxa_i2c_board_gpio helandkb_pwr_i2c_gpio[] = {
	...
	{
		.type = "bq24157_6A",
		.gpio = mfp_to_gpio(GPIO029_GPIO_29),
	},
#endif
};
...
static struct stc311x_platform_data stc3115_platform_data = {
		...
		.Alm_Vbat = 3200,   /* Vbat alm level mV*/
...
static struct i2c_board_info __initdata stc3115_i2c_devices[] = {
	{
		...
		.irq			= MMP_GPIO_TO_IRQ(mfp_to_gpio(GPIO095_GPIO_95)), 
	},
};
#endif
...
static struct pxa_i2c_board_gpio helandkb_i2c2_gpio[] = {
#ifdef CONFIG_PN547_NFC
	{
		.type = "pn547",
		.gpio = mfp_to_gpio(GPIO030_GPIO_NFC_IRQ),
	},
#endif
};
...
#ifdef CONFIG_PN547_NFC
	 pxa_init_i2c_gpio_irq(ARRAY_AND_SIZE(helandkb_i2c2_gpio),
				ARRAY_AND_SIZE(helandkb_i2c2_info));
#endif	
