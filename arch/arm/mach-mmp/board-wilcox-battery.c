...
static sec_charging_current_t charging_current_table[] = {
	...
	{750,  750,   150,    1800},     /* POWER_SUPPLY_TYPE_MAINS */
	{550,   500,    150,    1800},     /* POWER_SUPPLY_TYPE_USB */
	{550,   500,    150,    1800},     /* POWER_SUPPLY_TYPE_USB_DCP */
	{550,   500,    150,    1800},     /* POWER_SUPPLY_TYPE_USB_CDP */
	{550,   500,    150,    1800},     /* POWER_SUPPLY_TYPE_USB_ACA */
	{550,   500,    150,   1800},     /* POWER_SUPPLY_TYPE_MISC */
	{0,     0,      0,      0},     /* POWER_SUPPLY_TYPE_CARDOCK */
	{550,   500,    150,    1800},     /* POWER_SUPPLY_TYPE_WPC */
	{750,  750,   150,    1800},     /* POWER_SUPPLY_TYPE_UARTOFF */
};
...
void __init pxa986_wilcox_battery_init(void)
{
	pr_info("%s: wilcox charger init\n", __func__);
