...
#include <mach/regs-apmu.h>
#if defined(CONFIG_SOC_CAMERA_S5K4ECGX) // For 5M Camera Sensor (S5K4ECGX)
#include <mach/samsung_camera_baffin.h>
#endif

#include "board-baffin.h"
...
#endif
#if defined(CONFIG_TOUCHSCREEN_BT531_TS)
#include <linux/input/bt531_ts.h>
#endif
#if defined(CONFIG_TOUCHSCREEN_BT432_TS)
...
#include "../../../drivers/sensor/sensors_core.h"
#endif
...
static unsigned long emeidkb_pin_config_rev00[] __initdata = {
	...
	GPIO006_GPIO_6 | MFP_LPM_INPUT | MFP_PULL_LOW,
...
#define GPIO010_ACC_INT	(GPIO010_GPIO_10 | MFP_PULL_LOW | MFP_LPM_INPUT)
	GPIO010_ACC_INT,
...
#define GPIO020_CAM_FLASH_EN	(GPIO020_GPIO_20 | MFP_LPM_DRIVE_LOW)
	...
	GPIO029_GPIO_29 | MFP_LPM_INPUT | MFP_PULL_HIGH,

#define GPIO030_GPI0_MIC_BIAS_EN	(GPIO030_GPIO_30 | MFP_LPM_INPUT | MFP_PULL_LOW)
	GPIO030_GPI0_MIC_BIAS_EN,
...
#define GPIO033_GPIO_NFC_SCL	(GPIO033_GPIO_33 | MFP_PULL_LOW | MFP_LPM_INPUT)
#define GPIO034_GPIO_NFC_SDA	(GPIO034_GPIO_34 | MFP_PULL_LOW | MFP_LPM_INPUT)
	GPIO033_GPIO_NFC_SCL,
	GPIO034_GPIO_NFC_SDA,
...
#define GPIO053_AP_AGPS_RESET	(GPIO053_GPIO_53)
    ...
    GPIO075_GPIO_75 | MFP_LPM_DRIVE_HIGH,
...
#define GPIO087_TSP_SCL		(GPIO087_GPIO_87 | MFP_LPM_FLOAT)
#define GPIO088_TSP_SDA		(GPIO088_GPIO_88 | MFP_LPM_FLOAT)
	GPIO087_TSP_SCL,
	GPIO088_TSP_SDA,

	GPIO089_GPIO_89 | MFP_LPM_INPUT | MFP_PULL_LOW,

#define GPIO090_T_FLASH_DETECT	(GPIO090_GPIO_90 | MFP_LPM_INPUT | MFP_PULL_HIGH)
...
#define GPIO094_GPIO_TSP_INT	(GPIO094_GPIO_94 | MFP_LPM_INPUT)
	...
	GPIO095_GPIO_95 | MFP_LPM_INPUT | MFP_PULL_HIGH,

#define GPIO096_GPIO_MOTOR_EN	(GPIO096_GPIO_96 | MFP_LPM_INPUT)
...
#define GPIO124_LCD_BL_CTRL	(GPIO124_GPIO_124 | MFP_PULL_LOW | MFP_LPM_DRIVE_LOW)
	GPIO124_LCD_BL_CTRL,

#define GPIO126_GPIO_NFC_EN	(GPIO126_GPIO_126 | MFP_LPM_INPUT | MFP_PULL_LOW)
#define GPIO127_GPIO_NFC_FIRMWARE	(GPIO127_GPIO_127 | MFP_LPM_INPUT | MFP_PULL_LOW)
	GPIO126_GPIO_NFC_EN,
	GPIO127_GPIO_NFC_FIRMWARE,
...
static unsigned long emeidkb_pin_config_rev01[] __initdata = {
//	GPIO000_KP_MKIN0,			/* KP_MKIN[0] */
//	GPIO001_KP_MKOUT0 | MFP_LPM_DRIVE_HIGH
//			  | MFP_PULL_FLOAT,	/* KP_MKOUT[0] */
//	GPIO002_KP_MKIN1,			/* KP_MKIN[1] */
	GPIO000_GPIO_0 | MFP_LPM_INPUT, 	/* VOL_DN */
	GPIO001_GPIO_1 | MFP_LPM_INPUT | MFP_PULL_HIGH, 					
	GPIO002_GPIO_2 | MFP_LPM_INPUT, 	/* VOL_UP */
	GPIO003_GPIO_3 | MFP_LPM_INPUT | MFP_PULL_HIGH,
	GPIO004_GPIO_4 | MFP_PULL_HIGH,
	GPIO005_GPIO_5 | MFP_LPM_INPUT | MFP_PULL_HIGH,
	GPIO006_GPIO_6 | MFP_LPM_INPUT | MFP_PULL_HIGH,
	GPIO007_GPIO_7 | MFP_LPM_INPUT | MFP_PULL_HIGH,
	GPIO008_GPIO_8 | MFP_LPM_INPUT | MFP_PULL_LOW,
	GPIO009_GPIO_9 | MFP_LPM_INPUT | MFP_PULL_HIGH,
...
#define GPIO011_GPI0_TSP_VALID	(GPIO011_GPIO_11 | MFP_LPM_INPUT | MFP_PULL_HIGH)
	...
	GPIO012_GPIO_12 | MFP_LPM_INPUT | MFP_PULL_HIGH,
//	GPIO013_KP_DKIN4,
...
#define GPIO020_CAM_FLASH_EN	(GPIO020_GPIO_20 | MFP_LPM_DRIVE_LOW)
	...
	GPIO030_GPIO_30 | MFP_LPM_INPUT | MFP_PULL_HIGH,
...
#define GPIO032_HW_REV_MOD_2	(GPIO032_GPIO_32 | MFP_PULL_LOW | MFP_LPM_INPUT)
	...
	GPIO033_GPIO_33 | MFP_PULL_HIGH | MFP_LPM_INPUT,
...
#define GPIO043_GPIO_DVC1	(GPIO043_GPIO_43 | MFP_LPM_INPUT | MFP_PULL_HIGH)
#define GPIO044_GPIO_DVC2	(GPIO044_GPIO_44 | MFP_LPM_INPUT | MFP_PULL_HIGH)
	GPIO043_GPIO_DVC1,
	GPIO044_GPIO_DVC2,
...
#define GPIO053_AP_AGPS_RESET	(GPIO053_GPIO_53)
	...
	GPIO067_GPIO_67 | MFP_LPM_INPUT | MFP_PULL_HIGH,
	GPIO068_GPIO_68 | MFP_LPM_INPUT | MFP_PULL_HIGH,
	GPIO069_GPIO_69 | MFP_LPM_INPUT | MFP_PULL_HIGH,
	GPIO070_GPIO_70 | MFP_LPM_INPUT | MFP_PULL_HIGH,
	GPIO071_GPIO_71 | MFP_LPM_INPUT | MFP_PULL_HIGH,
	GPIO072_GPIO_72 | MFP_LPM_INPUT | MFP_PULL_HIGH,
	GPIO073_GPIO_73 | MFP_LPM_INPUT | MFP_PULL_HIGH,
	GPIO074_GPIO_74 | MFP_LPM_INPUT | MFP_PULL_HIGH,

    GPIO075_GPIO_75 | MFP_LPM_DRIVE_HIGH,
	GPIO076_GPIO_76 | MFP_LPM_INPUT | MFP_PULL_HIGH,

	GPIO077_CAM_MCLK  | MFP_LPM_DRIVE_LOW, /* CAM_MCLK */
	GPIO078_GPIO_78 | MFP_LPM_INPUT | MFP_PULL_HIGH,
	GPIO079_CAM_SCL | MFP_LPM_FLOAT,
	GPIO080_CAM_SDA | MFP_LPM_FLOAT,

	GPIO081_GPIO_81 | MFP_LPM_INPUT | MFP_PULL_HIGH,
	GPIO082_GPIO_82 | MFP_LPM_INPUT | MFP_PULL_HIGH,
#define GPIO083_GPIO_HOST_WU_WLAN	(GPIO083_GPIO_83 | MFP_LPM_DRIVE_LOW)
#define GPIO084_GPIO_WLAN_WU_HOST	(GPIO084_GPIO_84 | MFP_LPM_INPUT | MFP_PULL_LOW)
#define GPIO085_GPIO_WL_REG_ON	GPIO085_GPIO_85
#define GPIO086_GPIO_BT_REG_ON	GPIO086_GPIO_86
...
#define GPIO090_T_FLASH_DETECT	(GPIO090_GPIO_90 | MFP_LPM_INPUT | MFP_PULL_HIGH)
	...
	GPIO091_GPIO_91 | MFP_LPM_INPUT | MFP_PULL_HIGH,
	GPIO092_GPIO_92 | MFP_LPM_INPUT | MFP_PULL_HIGH,
#define GPIO093_GPIO_MUIC_INT	GPIO093_GPIO_93
#define GPIO094_GPIO_TSP_INT	GPIO094_GPIO_94 | MFP_LPM_INPUT
	GPIO093_GPIO_MUIC_INT,
	GPIO094_GPIO_TSP_INT,
	...
	GPIO096_GPIO_96 | MFP_LPM_INPUT | MFP_PULL_HIGH,
...
#define GPIO124_LCD_BL_CTRL	(GPIO124_GPIO_124 | MFP_PULL_LOW | MFP_LPM_DRIVE_LOW)
	...
	GPIO126_GPIO_126 | MFP_LPM_INPUT | MFP_PULL_HIGH,
	GPIO127_GPIO_127 | MFP_LPM_INPUT | MFP_PULL_HIGH,
...
__weak struct regulator_consumer_supply d2199_ldo8_supplies[] = {
	REGULATOR_SUPPLY("v_motor_3v3", NULL),
};
...
__weak struct regulator_consumer_supply d2199_ldo9_supplies[] = {
	REGULATOR_SUPPLY("v_tsp_1v8", NULL),	// V_tsp_1.8V
};
...
__weak struct regulator_consumer_supply d2199_ldo15_supplies[] = {
	REGULATOR_SUPPLY("vmmc", "sdhci-pxav3.0"),	// V_MMC_3.3V
};
...
__weak struct regulator_consumer_supply d2199_ldo16_supplies[] = {
	REGULATOR_SUPPLY("vqmmc", "sdhci-pxav3.0"),	// V_SD_3.3V
};
...
static struct accel_platform_data accel_pdata = {
	.accel_position = 7, /*BaffinRD R01*/
	.axis_adjust = true,
};
static struct i2c_board_info i2c_bma254={
...
#if  defined(CONFIG_SENSORS_BMA254) || defined(CONFIG_SENSORS_BMA2X2) || defined(CONFIG_SENSORS_BMM050) || defined(CONFIG_SENSORS_GP2A002S)|| defined(CONFIG_SENSORS_GP2A030)
...
{
#if  defined(CONFIG_SENSORS_BMA254)
	i2c_register_board_info(5, &i2c_bma254, 1);
#elif defined(CONFIG_SENSORS_BMA2X2)
	i2c_register_board_info(5, &i2c_bma2x2, 1);
#elif defined(CONFIG_SENSORS_BMM050)
	i2c_register_board_info(5, &i2c_bmm050, 1);
#elif defined(CONFIG_SENSORS_GP2A002S)|| defined(CONFIG_SENSORS_GP2A030)
...
#if defined(CONFIG_TOUCHSCREEN_BT531_TS)
static struct bt531_ts_platform_data bt531_ts_pdata = {
	.gpio_int		= TSP_INT,
	.gpio_ldo_en	= NULL,
	.x_resolution	= 479,
	.y_resolution	= 799,
...
static struct pxa_i2c_board_gpio bt531_i2c_gpio[] = {
	{
		.type = BT531_TS_DEVICE,
		.gpio = TSP_INT,
	},
};
...
#if defined(CONFIG_TOUCHSCREEN_BT432_TS)
static struct bt432_ts_platform_data bt432_ts_pdata = {
	.gpio_int		= TSP_INT,
	.gpio_ldo_en	= NULL,
	.x_resolution	= 479,
	.y_resolution	= 799,
...
static struct pxa_i2c_board_gpio bt432_i2c_gpio[] = {
	{
		.type = BT432_TS_DEVICE,
		.gpio = TSP_INT,
	},
};
#endif
...
#if defined(CONFIG_TOUCHSCREEN_BT531_TS)
	{
		I2C_BOARD_INFO(BT531_TS_DEVICE, 0x20),
		.platform_data = &bt531_ts_pdata,	
	},
#endif
#if defined(CONFIG_TOUCHSCREEN_BT432_TS)
	{
		I2C_BOARD_INFO(BT432_TS_DEVICE, 0x20),
		.platform_data = &bt432_ts_pdata,	
	},
#endif
#if defined(CONFIG_TOUCHSCREEN_MMS136_TS)
	{
...
static void emei_dkb_set_bl(int intensity)
{
	...
	gpio_bl = mfp_to_gpio(GPIO124_LCD_BL_CTRL);
...
static struct vib_info vib_pin_info = {
	.gpio = mfp_to_gpio(GPIO096_GPIO_96),
};
...
#if 1
	if (system_rev == 0)
		mfp_config(ARRAY_AND_SIZE(emeidkb_pin_config_rev00));
	else
#endif
		mfp_config(ARRAY_AND_SIZE(emeidkb_pin_config_rev01));

/*remove it for it is code for marvell PMIC DVFS, now we use Dialog PMIC, don't use this pins*/
//	if (dvc_flag)
//		mfp_config(ARRAY_AND_SIZE(dvc_pin_config));
	...
	pxa_init_i2c_gpio_irq(ARRAY_AND_SIZE(bt531_i2c_gpio),
			ARRAY_AND_SIZE(emeidkb_i2c2_info));
#endif
#if defined (CONFIG_TOUCHSCREEN_BT432_TS)
	pr_info("add i2c device: TOUCHSCREEN ZINITIX\n");
	pxa_init_i2c_gpio_irq(ARRAY_AND_SIZE(bt432_i2c_gpio),
			ARRAY_AND_SIZE(emeidkb_i2c2_info));
#endif
#if defined (CONFIG_TOUCHSCREEN_CYPRESS_TMA46X)	
	pr_info("add i2c device: TOUCHSCREEN CYPRESS_TMA46X\n");
