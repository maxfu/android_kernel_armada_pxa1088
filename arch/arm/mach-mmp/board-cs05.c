...
static unsigned long helandkb_pin_config[] __initdata = {
	...
	GPIO003_GPIO_3 | MFP_LPM_INPUT | MFP_PULL_HIGH, /* PRJ_ON_HOTKEY */
	
	GPIO004_GPIO_4  | MFP_PULL_LOW | MFP_LPM_DRIVE_LOW, /* PRJ_ON */
	GPIO005_GPIO_5 | MFP_LPM_FLOAT, /* MPR_I2C0_SCL */
	GPIO006_GPIO_6 | MFP_LPM_FLOAT, /* MPR_I2C0_SDL */
	GPIO007_GPIO_7	| MFP_LPM_FLOAT, /* PRJ_RDY */
...
#define GPIO10_ACC_INT		(GPIO010_GPIO_10 | MFP_PULL_LOW | MFP_LPM_INPUT)
	...
	GPIO09_LCD_BL_CTRL,
	GPIO10_ACC_INT,
	GPIO011_GPIO_11 | MFP_PULL_LOW | MFP_LPM_DRIVE_LOW ,
...
#define GPIO020_CAM_FLASH_EN		(GPIO020_GPIO_20 | MFP_LPM_DRIVE_LOW)
	...
	GPIO016_GPIO_16 | MFP_LPM_INPUT | MFP_PULL_LOW, /* NC */
	GPIO017_GPIO_17 | MFP_LPM_INPUT | MFP_PULL_LOW, /* NC */
	GPIO018_LCD_RESET,
	...
	GPIO029_GPIO_29  | MFP_PULL_LOW | MFP_LPM_DRIVE_LOW, /* MP_ON */
	/*GPIO030_UART3_RTS,*/
...
#define GPIO032_HW_REV_MOD_2            (GPIO032_GPIO_32 | MFP_PULL_FLOAT)
	...
	GPIO033_GPIO_33 | MFP_LPM_INPUT | MFP_PULL_LOW,
	GPIO034_GPIO_34 | MFP_LPM_INPUT | MFP_PULL_HIGH, /*LOW -> TO VX*/
...
#define GPIO084_GPIO_WLAN_WU_HOST	(GPIO084_GPIO_84 | MFP_LPM_INPUT | MFP_PULL_FLOAT)
...
#define GPIO125_VX6B3E_RESET	(GPIO125_VCXO_REQ | MFP_PULL_LOW | MFP_LPM_PULL_LOW)
	GPIO125_VX6B3E_RESET,
...
#define GPIO_VCM_PWDN		ND_CS1N3_GPIO_102
	...
	GPIO127_GPIO_127 | MFP_PULL_LOW | MFP_LPM_PULL_LOW,
...
//	SM_RDY_GPIO_3 | MFP_PULL_HIGH | MFP_LPM_FLOAT,
	...
	ND_IO12_ND_DAT12 | MFP_PULL_LOW | MFP_LPM_FLOAT,
...
#define PROJECTOR_I2C_NAME "dpp3430"
#define PROJECTOR_I2C_TCH_ADR 0x1B

#define PROJECTOR_M08980_I2C_NAME "M08980"
#define PROJECTOR_M08980_I2C_TCH_ADR 0x36


static struct projector_dpp3430_platform_data  projector_dpp3430_pdata = {
	.gpio_scl = GPIO_BEAM_SCL,
	.gpio_sda = GPIO_BEAM_SDA,
	.gpio_pi_int = GPIO_BEAM_INT,
	.gpio_mp_on = GPIO_BEAM_MP_ON,		// Projector PMIC ON
	.gpio_prj_on = GPIO_BEAM_PRJ_ON,
	.gpio_prj_rdy = GPIO_BEAM_PRJ_RDY,
};

static struct i2c_gpio_platform_data i2c_projector_bus_data = {
	.sda_pin = BEAM_SDA,
	.scl_pin = BEAM_SCL,
	.udelay  = 3,
	.timeout = 100,
};
static struct platform_device i2c_projector_bus_device = {
	.name		= "i2c-gpio",
	.id		= 4,
	.dev = {
		.platform_data = &i2c_projector_bus_data,
	}
};

static struct i2c_board_info __initdata projector_i2c_devices[] = {
	{
		I2C_BOARD_INFO(PROJECTOR_I2C_NAME, PROJECTOR_I2C_TCH_ADR),
		.platform_data = &projector_dpp3430_pdata,
		.irq = MMP_GPIO_TO_IRQ(BEAM_INT),
	},
	{
		I2C_BOARD_INFO(PROJECTOR_M08980_I2C_NAME, PROJECTOR_M08980_I2C_TCH_ADR),
	},
};

/*
static struct i2c_board_info __initdata projector_m08980_i2c_devices[] = {
};
*/
...
static struct i2c_board_info helandkb_i2c2_info[] = {
	...
	{
		I2C_BOARD_INFO("mms_ts", 0x48),
		.irq = MMP_GPIO_TO_IRQ(mfp_to_gpio(GPIO094_GPIO_94)),
	},
#endif
#if defined(CONFIG_VX6B3E_BRIDGE)
{
		I2C_BOARD_INFO("vx6b3e", 0x64),
		.platform_data = "vx6b3e",
},
#endif
};
#if defined(CONFIG_TOUCHSCREEN_CYPRESS_TMA46X)
...
/* temporry for bring up */
#define MFP_WIB_RESETn		91 //(GPIO034_GPIO_34 | MFP_PULL_FLOAT)
...
#define KEY_PROJECTOR 224
struct gpio_keys_button gpio_keys[] = 
{
	{
		.code = KEY_PROJECTOR,       /* input event code (KEY_*, SW_*) */
		.gpio = mfp_to_gpio(GPIO003_GPIO_3),
		.active_low = 1,
		.desc = "key_projector",
...
#if defined (CONFIG_USE_DPP2601)	
	pr_info("add i2c device: Projector Module\n");
	platform_device_register(&i2c_projector_bus_device);
	i2c_register_board_info(4, ARRAY_AND_SIZE(projector_i2c_devices));
	//i2c_register_board_info(4, ARRAY_AND_SIZE(projector_m08980_i2c_devices));
#endif
