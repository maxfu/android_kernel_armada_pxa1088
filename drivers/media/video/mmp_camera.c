...
#if defined(CONFIG_MACH_WILCOX) || defined(CONFIG_MACH_CT01) || defined(CONFIG_MACH_CS05)
...
static irqreturn_t mmp_camera_frameirq(int irq, void *data)
{
	...
	for (frame = 0; frame < pcdev->nbufs; frame++)
		...
		|| defined(CONFIG_MACH_BAFFIN) || defined(CONFIG_MACH_CT01) || defined(CONFIG_MACH_CS05)
