...
#if 0//def CONFIG_MACH_CS05
#define CONFIG_TOUCHSCREEN_CYPRESS_CYTTSP4_USE_FW_BIN_FILE
#endif

#ifdef SAMSUNG_SYSINFO_DATA
#if defined(CONFIG_MACH_BAFFIN)
#define SAMSUNG_HW_VERSION			0x13
#define SAMSUNG_FW_VERSION			0x1300
#define SAMSUNG_CONFIG_VERSION		0x15
#elif defined(CONFIG_MACH_CS05)
#define SAMSUNG_HW_VERSION			0x01
#define SAMSUNG_FW_VERSION			0x0300
#define SAMSUNG_CONFIG_VERSION		0x03
#else //CONFIG_MACH_WILLCOX
#define SAMSUNG_HW_VERSION			0x05
#define SAMSUNG_FW_VERSION			0x1500
#define SAMSUNG_CONFIG_VERSION		0x15
#endif
#endif
...
#if 0//def CONFIG_MACH_CS05
#define FORCED_UPGRADE_FIRMWARE
#endif
		...
		u32 fw_revctrl_new_h, u32 fw_revctrl_new_l)
{
	...
	dev_info(dev, "%s: img hw vers:0x%01X new hw vers:0x%01X\n", __func__,
			hw_ver_img, SAMSUNG_HW_VERSION);
	dev_info(dev, "%s: img fw vers:0x%02X new fw vers:0x%02X\n", __func__,
			fw_ver_img, SAMSUNG_FW_VERSION);
	dev_info(dev, "%s: img config vers:0x%01X new config vers:0x%01X\n", __func__,
