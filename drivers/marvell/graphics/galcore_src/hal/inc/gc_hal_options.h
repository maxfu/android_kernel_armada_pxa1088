...
#ifdef CONFIG_CPU_PXA1188
#define MRVL_PLATFORM_PXA1188                   1
#else
#define MRVL_PLATFORM_PXA1188                   0
#endif
...
#if MRVL_PLATFORM_MMP3 || MRVL_PLATFORM_NEVO || MRVL_PLATFORM_988 || MRVL_PLATFORM_PXA1088
...
#if (defined ANDROID) && (!VIVANTE_PROFILER) && ((MRVL_PLATFORM_988) || (MRVL_PLATFORM_PXA1088))
...
*/
#if (defined ANDROID) && ((MRVL_PLATFORM_NEVO) || (MRVL_PLATFORM_988) || (MRVL_PLATFORM_PXA1088)) && (!VIVANTE_PROFILER)
...
#if MRVL_PLATFORM_PXA1088 || MRVL_PLATFORM_PXA1188
#define MRVL_2D3D_CLOCK_SEPARATED               1
#else
#define MRVL_2D3D_CLOCK_SEPARATED               0
#endif

#if MRVL_PLATFORM_PXA1188
...
#define _GC_VERSION_STRING_                     "GC Ver SS_rls_pxa988_JB42_R1_RC2_GC13.7"
