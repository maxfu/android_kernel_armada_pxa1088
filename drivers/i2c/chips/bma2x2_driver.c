...
#if defined(CONFIG_MACH_HELANDELOS) || defined(CONFIG_MACH_WILCOX) || defined(CONFIG_MACH_CS02) || defined(CONFIG_MACH_CT01)
		...
		offsetfilt)
{
	...
	comres = bma2x2_smbus_write_byte(client, BMA2X2_OFFSET_X_AXIS_REG,
						&data);
	printk(KERN_INFO "[ACC] %s (%d)",__func__,(signed int)data);
	return comres;
}
						...
						*offsetfilt)
{
	...
	comres = bma2x2_smbus_read_byte(client, BMA2X2_OFFSET_X_AXIS_REG,
						&data);
	*offsetfilt = data;
	printk(KERN_INFO "[ACC] %s data(%x)(%d) (%d)",__func__,data, data,*offsetfilt);
	return comres;
}
						...
						offsetfilt)
{
	...
	comres = bma2x2_smbus_write_byte(client, BMA2X2_OFFSET_Z_AXIS_REG,
						&data);
	printk(KERN_INFO "[ACC] %s (%d)",__func__,(int *)&data);
	return comres;
}
...
static void bma2x2_early_suspend(struct early_suspend *h)
{
	...
	GPIO010_GPIO_10 | MFP_PULL_LOW|MFP_LPM_INPUT|MFP_LPM_PULL_LOW, //ACC_INT
	};
